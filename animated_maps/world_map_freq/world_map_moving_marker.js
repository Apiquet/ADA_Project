...
L.Marker.MovingMarker = L.Marker.extend({
    ...
    initialize: function (latlngs, dates, colors, durations, options) {
...
L.Marker.movingMarker = function (latlngs, dates, colors, duration, options) {
    return new L.Marker.MovingMarker(latlngs, dates, colors, duration, options);
};
