...
L.Marker.MovingMarker = L.Marker.extend({
    ...
    initialize: function (latlngs, dates, types, counts, durations, options) {
...
L.Marker.movingMarker = function (latlngs, dates, types, counts, duration, options) {
    return new L.Marker.MovingMarker(latlngs, dates, types, counts, duration, options);
};
